...
$result = mysqli_query($con, "DELETE FROM serti WHERE id=$id");
...
if ($result) {
    ...
    <script>
        $(document).ready(function() {
            ...
            Swal.fire({
                title: 'Berhasil!',
                text: 'Data serti berhasil dihapus.',
                icon: 'success',
                confirmButtonText: 'OK'
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = '?page=serti'; // Arahkan kembali ke halaman daftar serti
                }
            }).finally(function() {
