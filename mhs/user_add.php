...
if (isset($_POST['submit'])) {
    ...
    // Mengunggah file dan memastikan semua file berhasil diunggah
    ...
    // Menambahkan user_id ke dalam query SQL
    $sql = "INSERT INTO mhs (user_id, nama, jekel, tlahir, tgllahir, agama, status, negara, alamat, telp, email, darah, institusi, jenjang, jurusan, semester, nim, orientasi, awal, akhir, hubungan, namaWali, jekelWali, umur, alamatWali, pendidikan, pekerjaan, telpWali, foto, tertib, persetujuan, surhat) 
            VALUES ('$user_id', '$nama', '$jekel', '$tlahir', '$tgllahir', '$agama', '$status', '$negara', '$alamat', '$telp', '$email', '$darah', '$institusi', '$jenjang', '$jurusan', '$semester', '$nim', '$orientasi', '$awal', '$akhir', '$hubungan', '$namaWal', '$jekelWali', '$umur', '$alamatWali', '$pendidikan', '$pekerjaan', '$telpWali', '$foto', '$tertib', '$persetujuan', '$surhat')";
    ...
    <div class="ibox-body">
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="file" name="tertib" accept=".jpg,.jpeg,.png,.pdf" placeholder>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Persetujuan Orang Tua</label>
                <div class="col-sm-10">
                    <input type="file" name="persetujuan" accept=".jpg,.jpeg,.png,.pdf" placeholder>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Surat Keterangan</label>
                <div class="col-sm-10">
                    <input type="file" name="surhat" accept=".jpg,.jpeg,.png,.pdf" placeholder>
                </div>
            </div>
            <div class="form-group row">
