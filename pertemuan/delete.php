...
$result = mysqli_query($con, "DELETE FROM pertemuan WHERE id=$id");
...
if ($result) {
    ...
    <script>
        $(document).ready(function() {
            ...
            Swal.fire({
                title: 'Berhasil!',
                text: 'Data pertemuan berhasil dihapus.',
                icon: 'success',
                confirmButtonText: 'OK'
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = '?page=pertemuan'; // Arahkan kembali ke halaman daftar pertemuan
                }
            }).finally(function() {
