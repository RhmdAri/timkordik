...
$result = mysqli_query($con, "DELETE FROM pelaksanaan WHERE id=$id");
...
if ($result) {
    ...
    <script>
        $(document).ready(function() {
            ...
            Swal.fire({
                title: 'Berhasil!',
                text: 'Data pelaksanaan berhasil dihapus.',
                icon: 'success',
                confirmButtonText: 'OK'
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = '?page=pelaksanaan'; // Arahkan kembali ke halaman daftar pelaksanaan
                }
            }).finally(function() {
